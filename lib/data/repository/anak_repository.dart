...
import 'package:canary_app/data/models/request/admin/anak_request_model.dart';
import 'package:canary_app/data/models/response/get_all_anak_response.dart';
  ...
  Future<Either<String, GetAnakById>> addAnak(
    ...
    try {
      final response = await _serviceHttpClient.postWithToken(
        "admin/anak",
        requestModel.toMap(), // Ganti toJson() ke toMap()
      );
